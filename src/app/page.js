      ...
      <main className="flex-1">
        <div className="max-w-4xl mx-auto p-8">
              ...
              <div className="grid md:grid-cols-2 gap-x-8 gap-y-6">
                <div className="border-t border-[#FEE9E1] pt-4">
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <span className="text-sm font-medium text-[#5C4B46]">Rp 1.500</span>
                  </div>
                ...
                <div className="border-t border-[#FEE9E1] pt-4">
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <span className="text-sm font-medium text-[#5C4B46]">Rp 1.000</span>
                  </div>
                ...
                <div className="border-t border-[#FEE9E1] pt-4">
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <span className="text-sm font-medium text-[#5C4B46]">Rp 2.000</span>
                  </div>
          ...
          <section id="makeup" className="pt-12 mb-16 bg-[#FEE9E1] rounded-lg p-8">
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-bold text-[#5C4B46] mb-6">Makeup Services</h2>
              <div className="grid md:grid-cols-2 gap-x-8 gap-y-6">
                <div className="border-t border-[#F4DBD3] pt-4">
                  <div className="flex justify-between items-start mb-2">
                    <h3 className="text-xl font-semibold text-[#5C4B46]">Bridal Makeup</h3>
                    <span className="text-sm font-medium text-[#5C4B46]">Rp 1.500.000</span>
                  </div>
                  <p className="text-[#7B6A66]">Complete makeup package for the bride on her special day.</p>
                </div>
                <div className="border-t border-[#F4DBD3] pt-4">
                  <div className="flex justify-between items-start mb-2">
                    <h3 className="text-xl font-semibold text-[#5C4B46]">Party Makeup</h3>
                    <span className="text-sm font-medium text-[#5C4B46]">Rp 500.000</span>
                  </div>
                  <p className="text-[#7B6A66]">Stunning makeup for parties, graduations, and other events.</p>
                </div>
              </div>
            </div>
            <div className="text-center">
          ...
          <section id="manicure" className="pt-12 mb-16">
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-bold text-[#5C4B46] mb-6">Nail Care</h2>
              <div className="grid md:grid-cols-2 gap-x-8 gap-y-6">
                <div className="border-t border-[#FEE9E1] pt-4">
                  <div className="flex justify-between items-start mb-2">
                    <h3 className="text-xl font-semibold text-[#5C4B46]">Classic Manicure</h3>
                    <span className="text-sm font-medium text-[#5C4B46]">Rp 120.000</span>
                  </div>
                  <p className="text-[#7B6A66]">Nail shaping, cuticle care, hand massage, and regular polish.</p>
                </div>
                <div className="border-t border-[#FEE9E1] pt-4">
                  <div className="flex justify-between items-start mb-2">
                    <h3 className="text-xl font-semibold text-[#5C4B46]">Gel Pedicure</h3>
                    <span className="text-sm font-medium text-[#5C4B46]">Rp 250.000</span>
                  </div>
                  <p className="text-[#7B6A66]">A long-lasting pedicure with gel polish that stays shiny for weeks.</p>
                </div>
              </div>
            </div>
            <div className="text-center">
          ...
          <section id="skincare" className="pt-12 mb-16 bg-[#FEE9E1] rounded-lg p-8">
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-bold text-[#5C4B46] mb-6">Skin Treatments</h2>
              <div className="grid md:grid-cols-2 gap-x-8 gap-y-6">
                <div className="border-t border-[#F4DBD3] pt-4">
                  <div className="flex justify-between items-start mb-2">
                    <h3 className="text-xl font-semibold text-[#5C4B46]">Deep Cleansing</h3>
                    <span className="text-sm font-medium text-[#5C4B46]">Rp 300.000</span>
                  </div>
                  <p className="text-[#7B6A66]">A thorough cleansing to remove impurities and refresh the skin.</p>
                </div>
                 <div className="border-t border-[#F4DBD3] pt-4">
                  <div className="flex justify-between items-start mb-2">
                    <h3 className="text-xl font-semibold text-[#5C4B46]">Anti-Aging</h3>
                    <span className="text-sm font-medium text-[#5C4B46]">Rp 450.000</span>
                  </div>
                  <p className="text-[#7B6A66]">Reduces fine lines and promotes a youthful, radiant complexion.</p>
                </div>
              </div>
            </div>
             <div className="text-center">
          ...
          <section id="facial" className="pt-12 mb-16">
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-bold text-[#5C4B46] mb-6">Facial Services</h2>
              <div className="grid md:grid-cols-2 gap-x-8 gap-y-6">
                <div className="border-t border-[#FEE9E1] pt-4">
                  <div className="flex justify-between items-start mb-2">
                    <h3 className="text-xl font-semibold text-[#5C4B46]">Hydrating Facial</h3>
                    <span className="text-sm font-medium text-[#5C4B46]">Rp 350.000</span>
                  </div>
                  <p className="text-[#7B6A66]">Intensely moisturizes and nourishes dehydrated skin for a radiant glow.</p>
                </div>
                 <div className="border-t border-[#FEE9E1] pt-4">
                  <div className="flex justify-between items-start mb-2">
                    <h3 className="text-xl font-semibold text-[#5C4B46]">Brightening Facial</h3>
                    <span className="text-sm font-medium text-[#5C4B46]">Rp 400.000</span>
                  </div>
                  <p className="text-[#7B6A66]">Evens out skin tone and enhances your natural radiance.</p>
                </div>
              </div>
            </div>
             <div className="text-center">
